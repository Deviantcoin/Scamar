...
extern UniValue setzscmseed(const UniValue& params, bool fHelp);
extern UniValue getzscmseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzscm(const UniValue& params, bool fHelp);
extern UniValue dzscmstate(const UniValue& params, bool fHelp);
