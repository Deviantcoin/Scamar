...
/* Scamar GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Scamar"
#define QAPP_ORG_DOMAIN "scamar.io"
#define QAPP_APP_NAME_DEFAULT "Scamar-Qt"
#define QAPP_APP_NAME_TESTNET "Scamar-Qt-testnet"
