...
/** Utility functions used by the Scamar Qt UI.
 */
namespace GUIUtil
{
...
// Render Scamar addresses in monospace font
...
// Parse "scamar:" URI into recipient object, return true on successful parsing
