                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Scamar Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Scamar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scamar: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSCM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Scamar Core"), this);
    aboutAction->setStatusTip(tr("Show information about Scamar Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Scamar"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Scamar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Scamar addresses"));
    ...
    openAction->setStatusTip(tr("Open a Scamar: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Scamar Core help message to get a list with possible Scamar command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Scamar Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Scamar network", "", count));
}
...
{
    QString strTitle = tr("Scamar Core"); // default title
