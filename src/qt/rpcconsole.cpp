                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSCMPathCustom = GetArg("-zscmbackuppath", "");
    ...
    if(!strzSCMPathCustom.empty()) {
        ui->wallet_customzscmbackuppath->setText(QString::fromStdString(strzSCMPathCustom));
        ui->wallet_customzscmbackuppath_label->setVisible(true);
        ui->wallet_customzscmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSCMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Scamar RPC console.") + "<br>" +
