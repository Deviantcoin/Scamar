...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 50100;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Scamar starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Scamar: 1 day
        nTargetSpacing = 1 * 60;  // Scamar: 1 minute
        nMaturity = 10;
        ...
        nBlockZerocoinV2 = 2000; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        ...
        vSeeds.push_back(CDNSSeedData("seed1.scamarcoin.io", "seed1.scamarcoin.io"));              
        vSeeds.push_back(CDNSSeedData("seed2.scamarcoin.io", "seed2.scamarcoin.io"));
...
//        vSeeds.push_back(CDNSSeedData("209.97.131.20", "209.97.131.20"));   
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zscm to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "scamar-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "scamar-testnet.seed2.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        //vSeeds.push_back(CDNSSeedData("192.168.100.2", "192.168.100.2"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 129); // Testnet scamar addresses start with 't' or 'u'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 14);  // Testnet scamar script addresses start with '6' or '7'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet scamar BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x2a)(0x40)(0x71)(0xb0).convert_to_container<std::vector<unsigned char> >();
        // Testnet scamar BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x2a)(0x40)(0x78)(0x47).convert_to_container<std::vector<unsigned char> >();
        // Testnet scamar BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Scamar: 1 day
        nTargetSpacing = 1 * 60;        // Scamar: 1 minutes
