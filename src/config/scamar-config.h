/* src/config/scamar-config.h.  Generated from scamar-config.h.in by configure.  */
/* src/config/scamar-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.scamar.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Scamar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Scamar Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "scamar"
