...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Scamar features */
        {"scamar", "masternode", &masternode, true, true, false},
        {"scamar", "listmasternodes", &listmasternodes, true, true, false},
        {"scamar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"scamar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"scamar", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"scamar", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"scamar", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"scamar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"scamar", "masternodedebug", &masternodedebug, true, true, false},
        {"scamar", "startmasternode", &startmasternode, true, true, false},
        {"scamar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"scamar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"scamar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"scamar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"scamar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"scamar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"scamar", "mnbudget", &mnbudget, true, true, false},
        {"scamar", "preparebudget", &preparebudget, true, true, false},
        {"scamar", "submitbudget", &submitbudget, true, true, false},
        {"scamar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"scamar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"scamar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"scamar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"scamar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"scamar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"scamar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"scamar", "checkbudgets", &checkbudgets, true, true, false},
        {"scamar", "mnsync", &mnsync, true, true, false},
        {"scamar", "spork", &spork, true, true, false},
        {"scamar", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzscmseed", &getzscmseed, false, false, true},
        {"zerocoin", "setzscmseed", &setzscmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzscm", &searchdzscm, false, false, true},
        {"zerocoin", "dzscmstate", &dzscmstate, false, false, true}
...
{
    return "> scamar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50099/\n";
}
