...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Scamar Core scamar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  scamar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded scamar transaction") + "\n" +
                               "  scamar-tx [options] -create [commands]   " + _("Create hex-encoded scamar transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded scamar transaction
