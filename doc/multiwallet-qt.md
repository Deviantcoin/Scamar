...
In order to support loading of multiple wallets in scamar-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is scamar.cpp.
...
Changes to scamar.cpp
----------------------
scamar.cpp is the entry point into scamar-qt, and as such, will require some minor modifications to provide hooks for
