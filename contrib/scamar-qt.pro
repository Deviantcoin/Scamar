...
RESOURCES += src/qt/scamar.qrc src/qt/scamar_locale.qrc

TRANSLATIONS += src/qt/locale/scamar_bg.ts \
                src/qt/locale/scamar_de.ts \
                src/qt/locale/scamar_en.ts \
                src/qt/locale/scamar_es.ts \
                src/qt/locale/scamar_fi.ts \
                src/qt/locale/scamar_fr.ts \
                src/qt/locale/scamar_it.ts \
                src/qt/locale/scamar_ja.ts \
                src/qt/locale/scamar_pl.ts \
                src/qt/locale/scamar_pt.ts \
                src/qt/locale/scamar_ru.ts \
                src/qt/locale/scamar_sk.ts \
                src/qt/locale/scamar_sv.ts \
                src/qt/locale/scamar_vi.ts \
                src/qt/locale/scamar_zh_CN.ts \
                src/qt/locale/scamar_zh_TW.ts
