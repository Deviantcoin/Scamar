Contributing to Scamar Core
============================

The Scamar Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Scamar Core project, and is not to be
confused with overall Scamar Network Protocol consensus changes.

Whether a pull request is merged into Scamar Core rests with the project merge
...
Patches that change Scamar consensus rules are considerably more involved than
...
Where a patch set proposes to change the Scamar consensus, it must have been
...
The project leader is the release manager for each Scamar Core release.
